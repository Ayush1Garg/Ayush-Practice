<h2><a href="https://practice.geeksforgeeks.org/problems/queue-using-two-stacks/1?page=1&difficulty[]=0&status[]=unsolved&category[]=Arrays&category[]=Linked%20List&category[]=Stack&category[]=STL&category[]=CPP&category[]=two-pointer-algorithm&category[]=logical-thinking&category[]=OOP&curated[]=1&sortBy=difficulty">Queue using two Stacks</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Implement a Queue using 2 stacks<strong> s1</strong> and<strong> s2</strong> .<br>
