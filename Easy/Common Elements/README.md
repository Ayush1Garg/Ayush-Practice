<h2><a href="https://practice.geeksforgeeks.org/problems/common-elements5420/1?page=1&difficulty[]=0&status[]=unsolved&category[]=Arrays&category[]=Linked%20List&category[]=Stack&category[]=STL&category[]=CPP&category[]=two-pointer-algorithm&category[]=logical-thinking&category[]=OOP&curated[]=1&sortBy=difficulty">Common Elements</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two <strong>lists V1 and V2 of sizes n and m</strong> respectively. Return the list of elements common to both the lists and return the list in sorted order. Duplicates may be there in the output list.</span></p>
